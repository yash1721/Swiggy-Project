...
// const gameService = {
//   // Method to start the game with a list of player data
...
//     while (this.hasMoreThanOnePlayerAlive(activePlayers)) {
...
//   // Method to check if more than one player is still alive
